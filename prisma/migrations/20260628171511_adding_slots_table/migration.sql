/*
  ...
  - Made the column `reason` on table `availability_exceptions` required. This step will fail if there are existing NULL values in that column.

*/
-- AlterTable
ALTER TABLE "availability_exceptions" ALTER COLUMN "reason" SET NOT NULL;
